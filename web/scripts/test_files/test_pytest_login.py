...
def load_login_data():
    with open("test_data_json/login_test_data.json", "r", encoding="UTF-8") as file:
...
class TestLogin:
    ...
    @pytest.mark.parametrize("username, password, verify_code, expected_result", load_login_data())
